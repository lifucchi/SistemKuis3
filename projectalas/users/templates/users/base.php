...
<head>
    ...
    <link rel="stylesheet" href="{% static 'css/normalize.cs'%}">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">Kelas</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Kelas 4" href="1"><span class="mini-sub-pro">Kelas 4</span></a></li>
                                <li><a title="Kelas 5" href="2"><span class="mini-sub-pro">Kelas 5</span></a></li>
                                <li><a title="Kelas 6" href="3"><span class="mini-sub-pro">Kelas 6</span></a></li>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="{% url 'topic' %}" class="nav-link">Beranda</a>
                                                </li>
                                                {% if user.is_authenticated %}
                                                {% else %}
                                                <li class="nav-item"><a href="{% url 'login' %}" class="nav-link">Masuk Akun</a></li>
                                                {% endif %}
                                              ...
                                              {% if user.is_authenticated %}
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="#"><span class="edu-icon edu-user-rounded author-log-ic"></span>{{ user.first_name }} {{ user.last_name }}</a>
                                                        </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                      li><a data-toggle="collapse" data-target="#democrou" href="#">Kelas<span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                          <ul id="democrou" class="collapse dropdown-header-top">
                                              <li><a href="all-courses.html">Topik</a>
                                              </li>
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="{% url 'topic' %}">Beranda</a> <span class="bread-slash">/</span></li>
                                            <li><a href="#">Kelase</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Kelas 4</span>
                                            </li>
