...
from .views import TopicList , SubjectsList, ClassList, ScoreList,ScoreLists
from . import views
...
urlpatterns = [
    ...
    path(r"kelas/nilai/<int:pk>/", ScoreList.as_view(), name='scores'),
    path(r"kelas/topik/nilai/<int:pk>/", ScoreLists.as_view(), name='score'),
